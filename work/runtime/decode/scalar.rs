...
use coding_proto::coding::field::{Coding, CompoundCoding, ScalarCoding};
use coding_proto::coding::{field, Field};
use common::{derive_decoders, invalid_data, read_length_check_overflow, ActioDecoder};
use error::{Error, Result};

type ScalarDecoderFn = fn(&mut DecodeBuf<'_>) -> StdResult<Val, IoError>;
...
impl TonicDecoder for ScalarDecoder {
...
fn decode_expanded(_src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    // This needs to be handled in an outer layer.
    todo!()
}

#[inline(always)]
fn decode_bytes_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_string_utf8_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    ...
    match String::from_utf8(bytes.to_vec()) {
        ...
        Err(_utf8_error) => Err(invalid_data("Invalid UTF-8")),
    }
}
...
#[inline(always)]
fn decode_string_permissive_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    let len = read_length_check_overflow(src)?;
...
#[inline(always)]
fn decode_bool_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_int32_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_sint32_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_sfixed32_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_uint32_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_fixed32_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    if unlikely(src.remaining() < 4) {
        Err(invalid_data("Buffer overflow"))
    } else {
...
#[inline(always)]
fn decode_int64_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_sint64_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_sfixed64_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_uint64_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
...
#[inline(always)]
fn decode_fixed64_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    if unlikely(src.remaining() < 8) {
        Err(invalid_data("Buffer overflow"))
    } else {
...
#[inline(always)]
fn decode_float_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    if unlikely(src.remaining() < 4) {
        Err(invalid_data("Buffer overflow"))
    } else {
...
#[inline(always)]
fn decode_double_implicit(src: &mut DecodeBuf<'_>) -> StdResult<Val, IoError> {
    if unlikely(src.remaining() < 8) {
        Err(invalid_data("Buffer overflow"))
    } else {
